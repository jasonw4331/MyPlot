		...
		parent::__construct(
			...
			[
				new Dropdown(
                    ...
                    is_array($this->plot->helpers) && count($this->plot->helpers) < 1 ? [TextFormat::DARK_BLUE.$plugin->getLanguage()->get("removehelper.formnohelpers")] : array_map(function(string $text) {
