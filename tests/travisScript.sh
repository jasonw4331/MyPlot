...
[ ! -f phpstan.phar ] && echo "Downloading PHPStan..." && curl -sSLO https://api.github.com/repos/phpstan/phpstan/releases/latest \| grep "browser_download_url.*phar" \| cut -d : -f 2,3 \| tr -d \" \| wget -qi -
